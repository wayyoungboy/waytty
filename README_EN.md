...
<p align="center">
  <a href="https://github.com/wayyoungboy/waytty/releases/tag/v0.0.1"><strong>Download for macOS</strong></a> ·
...
The current release is **v0.0.1**, available as a macOS Universal package for Apple Silicon and Intel.

| Platform | Support | Get the app |
| --- | --- | --- |
| **macOS** | 12+, Universal: Apple Silicon / Intel | [Download ZIP](https://github.com/wayyoungboy/waytty/releases/download/v0.0.1/waytty-0.0.1-macos-universal.zip) |
...
[Release notes](https://github.com/wayyoungboy/waytty/releases/tag/v0.0.1) · [SHA-256 checksums](https://github.com/wayyoungboy/waytty/releases/download/v0.0.1/SHA256SUMS.txt) · [Upgrading and migration](docs/UPGRADING.md)
...
| **Email-account cloud backup** | Development preview, **not in the v0.0.1 download**. Client and standalone server code are implemented; production service configuration and email delivery testing remain pending. |
