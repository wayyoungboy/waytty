...
class CustomTextEditState extends State<CustomTextEdit> with TextInputClient {
  ...
  void performSelector(String selectorName) {
    // macOS Edit menu and Cmd+V arrive as native selectors, rather than
    // hardware key events. Route them through the terminal's existing actions.
    final intent = intentForMacOSSelector(selectorName);
    final target = widget.focusNode.context;
    if (intent != null && target != null) Actions.maybeInvoke(target, intent);
  }
