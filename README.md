...
这是可运行的开发版本，尚未完成 XTerminal 全功能逐项对照验收；功能状态见 [docs/PARITY.md](docs/PARITY.md)。
...
本项目基于 MIT 许可的 YourSSH 修改，详见 [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md) 和 [crossplatform/UPSTREAM.md](crossplatform/UPSTREAM.md)。不复制 XTerminal 应用代码、图标或用户数据库。
