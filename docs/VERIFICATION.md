...
- AI 仅使用 HTTP/SSE fixture，未消耗真实 API；远程 Supabase 未部署或访问。

可交付物：`dist/waytty.app`、`dist/waytty-macos.zip`。应用是当前开发版，完整功能与高保真验收范围见 PARITY.md。Windows/Android 尚未实机编译验收；包含 x86_64 代码不等于完成 Intel Mac 实机验收。
